...
public class EmployeeService {
	    ...
	    public static void applyLeave(int empId) {
	        ...
	        try (Connection con = DBUtil.getConnection()) {
	            ...
	            // validate leave type
	            String checkSql =
	                "SELECT COUNT(*) FROM leave_types WHERE leave_type_id = ?";
	            ...
	            String sql =
	            	    ...
	            	    "(leave_id, employee_id, leave_type_id, start_date, end_date, reason) " +
	            ...
	            DBUtil.logAction(empId,
	                "Applied leave from " + start + " to " + end);
	    ...
	    public static void viewLeaves(int empId) {
	        ...
	        try (Connection con = DBUtil.getConnection()) {
	            ...
	            System.out.printf("%-10s %-15s %-15s %-15s%n",
	                    "LEAVE ID", "START DATE", "END DATE", "STATUS");
	            System.out.println("-------------------------------------------------------");
	    ...
	    public static void viewHolidays() {
	        ...
	        try (Connection con = DBUtil.getConnection()) {
	            ...
	            ResultSet rs = con.createStatement()
	                    .executeQuery("SELECT holiday_date, description FROM holidays");
